...
{
    [Area("Customer")]
    public class PorcelainController : Controller
...

    {
        ...
        public PorcelainController(ApplicationDbContext db)
        {
            _db = db;
        ...
        public async Task<IActionResult> Index(int productPage = 1,int tagnumber=0)
        {
            productsPagingVM.Products = await _db.Products.Include(m => m.ProductTypes).Include(m => m.SpecialTags)
               ...
               .Where(a => a.ProductTypes.Name == "Porcelain"&&a.Deleted==false).ToListAsync();
            ...
            param.Append("/Customer/Porcelain?productPage=:");
        ...
        public IActionResult AddToFromSample(int id)
        {
            ...
            return RedirectToAction("Details", "Porcelain", new { area = "Customer",id=id,Message="The Products has been added to sample cart" });
        }
        ...
        public IActionResult RemoveFromSample(int id)
        {
            ...
            return RedirectToAction("Details", "Porcelain", new { area = "Customer",id=id, Message = "The Products has been removed" });
        }
        ...
        public async Task<IActionResult> AddtoShopping(int id, int Quantity=1, string fromUrl= "Details")
        {
            ...
            if(fromUrl== "Details")
            return RedirectToAction("Details", "Porcelain", new { area = "Customer",id=id, Message = "The Products has been added to shopping cart" });
            else
            return RedirectToAction(fromUrl, "Porcelain", new { area = "Customer", id = id, Message = "The Products has been added to shopping cart" });
        }
