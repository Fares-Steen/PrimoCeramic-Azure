...
namespace PrimoCeramic.Controllers
{
...

    {
        ...
        public CeramicController(ApplicationDbContext db)
        {
            _db = db;
        ...
        public async Task<IActionResult> Index(int productPage = 1,int tagnumber=0)
        {
            productsPagingVM.Products = await _db.Products.Include(m => m.ProductTypes).Include(m => m.SpecialTags)
               ...
               .Where(a => a.ProductTypes.Name == "Ceramic"&&a.Deleted==false).ToListAsync();
            ...
            param.Append("/Customer/Ceramic?productPage=:");
        ...
        public IActionResult AddToFromSample(int id)
        {
            ...
            return RedirectToAction("Details", "Ceramic", new { area = "Customer",id=id,Message="The Products has been added to sample cart" });
        }
        ...
        public IActionResult RemoveFromSample(int id)
        {
            ...
            return RedirectToAction("Details", "Ceramic", new { area = "Customer",id=id, Message = "The Products has been removed" });
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddtoShopping(int id, double Quantity=1, string fromUrl= "Details")
        {
            ...
            if (fromUrl == "Details")
                return RedirectToAction("Details", "Ceramic", new { area = "Customer", id = id, Message = "The Products has been added to shopping cart" });
            else
                 return RedirectToAction(fromUrl, "Ceramic", new { area = "Customer", id = id, Message = "The Products has been added to shopping cart" });
        ...
        public async Task AddtoShoppingindex(int id, int Quantity = 1)
        {
            bool isAuthenticated = User.Identity.IsAuthenticated;
